...
def init_db():
    ...
    readers_data = [
        ...
        ('DG004', 'Phạm Minh Đức', 'duc.pham@email.com', '0934567890', 'Sinh viên', 'Hết hạn', '2023-09-01', '2025-09-01'),
        ('DG005', 'Vũ Anh Khoa', 'khoa.vu@email.com', '0945678901', 'Độc giả ngoài', 'Hoạt động', '2026-01-10', '2027-01-10'),
